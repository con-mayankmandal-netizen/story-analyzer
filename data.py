...
# ── Column name aliases ──────────────────────────────────────────────────────
# Maps possible Excel column names → internal standard names
COLUMN_MAP = {
    # Writers / meta
    "Writers":                          "writers",
    "Meta Publishing Week":             "publish_week",
    "Daily Budget":                     "daily_budget",
    "Budget Cap":                       "budget_cap",
    "Geography":                        "geography",
    "Unique Name":                      "unique_name",
    "Asset Length":                     "asset_length",
    "Adset Code":                       "adset_code",
    "Adset Name":                       "adset_name",
    "Meta Link(Ad name)":               "meta_link",
    "Campaign":                         "campaign",
    "Script Name":                      "script_name",

    # Performance (Meta export names)
    "Results":                          "results",
    ...
    "3 Sec Play":                       "three_sec_play",
    "ThruPlay %":                       "thruplays_pct",
    "ThruPlays %":                      "thruplays_pct",
    "V 0% - 25%":                       "v0_25",
    "Video - 0% - 25%":                 "v0_25",
    "V 25% - 50%":                      "v25_50",
    "Video - 25% - 50%":                "v25_50",
...
# Numeric columns to aggregate (mean for rates, sum for counts/spend)
...
def load_and_aggregate(uploaded_file) -> tuple[pd.DataFrame, list[str]]:
    ...
    # Aggregate multi-week rows by adset_code
    agg_dict = {}
    for col in SUM_COLS:
    ...
    # Keep first value for metadata columns
    ...
    # Recompute cost_per_result after aggregation
...
def metrics_summary_text(metrics: dict) -> str:
    ...
    field_labels = {
        ...
        "spend_usd":            "Total Spend (USD)",
        "results":              "Total Installs",
        "cost_per_result":      "CPI (USD)",
        "reach":                "Reach",
        "impressions":          "Impressions",
        "cpm":                  "CPM (USD)",
        "ctr":                  "CTR (%)",
        "cti":                  "CTI (%)",
        "ctr_x_cti":            "CTR × CTI",
        "cpm_ctr_ratio":        "CPM/CTR",
        "three_sec_play":       "3-Sec Play Rate",
        "thruplays_pct":        "ThruPlay %",
        "v0_25":                "Video 0–25% Retention",
        "v25_50":               "Video 25–50% Retention",
        "v50_75":               "Video 50–75% Retention",
        "v75_95":               "Video 75–95% Retention",
        "v0_95":                "Video 0–95% Retention",
        "activation_pct":       "Activation %",
        "completion_thruplays": "0–95% Completion / ThruPlays",
        "daily_budget":         "Daily Budget (USD)",
        "budget_cap":           "Budget Cap (USD)",
    }
